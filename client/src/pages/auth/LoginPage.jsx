      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-indigo-900 p-12 lg:flex">
        ...
        <div className="relative z-10 max-w-md animate-fade-in-up text-white">
          <h2 className="text-3xl font-bold leading-tight">
            Split expenses.<br />Stay even. Stay friends.
          </h2>
          <p className="mt-4 text-white/80">
            Track shared bills, settle up instantly, and never chase a friend
            for rent money again.
          </p>
          ...
          <div className="mt-8 flex -space-x-3">
            {['A', 'B', 'C', 'D'].map((l, i) => (
              <div
                ...
                className="flex h-10 w-10 animate-fade-in-up items-center justify-center rounded-full border-2 border-white/40 bg-white/20 text-sm font-semibold text-white backdrop-blur-sm"
              >
                {l}
              </div>
            ))}
      ...
      <div className="relative flex w-full items-center justify-center bg-bg px-6 py-12 lg:w-1/2">
        ...
        <div className="relative w-full max-w-sm animate-fade-in-up rounded-2xl bg-surface p-8 shadow-xl shadow-slate-900/5 lg:bg-transparent lg:p-0 lg:shadow-none">
          ...
          >
            ...
            <div>
              ...
              <div className="mt-1.5 text-right">
                <Link to="/forgot-password" className="text-xs text-primary transition-colors hover:text-primary-dark hover:underline">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link to="/signup" className="font-medium text-primary transition-colors hover:text-primary-dark hover:underline">
              Sign up
            </Link>
          </p>
        </div>
